...
<div id="contentLeft">
  ...
  <p>
      ...
      <a href="/logout" class="menuItem">Cerrar sesi€n</a>
      <% } else{ %>
      <a href="/login.jsp" class="menuItem">Iniciar sesi€n</a>
      <% } %>
  </p>
...
<center><a href="/shop/cart.jsp" ><img src="/images/icons/cartEmpty.png" alt="Carrito" title="Ir al carrito (carrito vacÃo)" /></a></center>
  <% }else{ %>
<center><a href="/shop/cart.jsp" ><img src="/images/icons/cartFull.png" alt="Carrito" title="Ir al carrito" /></a></center>
  <% } %>
  <p>
      <b>N?mero de productos: </b><%= carro.getLenght() %><br />
