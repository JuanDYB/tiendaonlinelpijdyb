            ...
            <p>
                ...
                <table border="0" align="center" width="90%">
                    ...
                    <tr class="contentTable">
                        ...
                        <td><%= prod.getDesc() %></td>
                        <td>
                            <a href="/admin/administration/modifyprod.jsp?prod=<%= prod.getCodigo() %>"><img title="Editar producto" alt="Editar producto" src="/images/icons/editProd.png"/></a>&nbsp;&nbsp;
                            <a href="/admin/administration/delproduct.jsp?prod=<%= prod.getCodigo() %>"><img title="Borrar producto" alt="Borrar producto" src="/images/icons/deleteProd.png"/></a>
                        </td>
                    </tr>
                    <% } %>
                </table>
